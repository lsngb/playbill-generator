...
var show=function(){
	...
	xhttp.open("GET", "/cgi-bin/order_program.php?time="+time, true);
	xhttp.send();
}
...
var up=function(sender){
	...
	xhttp.open("GET", "/cgi-bin/program_up.php?input="+sender, true);
	xhttp.send();
}
...
var down=function(sender){
	...
	xhttp.open("GET", "/cgi-bin/program_down.php?input="+sender, true);
	xhttp.send();
}
var back=function(){
